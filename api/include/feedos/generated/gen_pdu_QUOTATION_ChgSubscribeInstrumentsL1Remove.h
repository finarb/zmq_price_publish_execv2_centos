...
#ifndef FEEDOS_generated_PDU_QUOTATION_ChgSubscribeInstrumentsL1Remove_H
#define FEEDOS_generated_PDU_QUOTATION_ChgSubscribeInstrumentsL1Remove_H

#include "gen_pdu_QUOTATION_notifications.h"

namespace FeedOS
{
namespace PDU_outbound_QUOTATION_ChgSubscribeInstrumentsL1Remove
{
	class Request: public PDU_outbound_Request
	{
	public:
		inline Request (uint32 const & a, ListOfPolymorphicInstrumentCode const & b) :
			PDU_outbound_Request (IDS::Request_QUOTATION_ChgSubscribeInstrumentsL1Remove)
		{
	...
	public:
		inline Response (ReturnCode rc) :
			PDU_outbound_Response (IDS::Response_QUOTATION_ChgSubscribeInstrumentsL1Remove, rc)
		{}
		inline Response () :
			PDU_outbound_Response (IDS::Response_QUOTATION_ChgSubscribeInstrumentsL1Remove, RC_OK)
		{
		}
	};
...
namespace PDU_inbound_QUOTATION_ChgSubscribeInstrumentsL1Remove
{
	class Request: public PDU_inbound_Request
	{
	public:
		inline Request (PDU const & p) :
			PDU_inbound_Request (IDS::Request_QUOTATION_ChgSubscribeInstrumentsL1Remove, p)
		{
	...
	public:
		inline Response (PDU const & p) :
			PDU_inbound_Response (IDS::Response_QUOTATION_ChgSubscribeInstrumentsL1Remove, p)
		{
