...
#ifndef FEEDOS_generated_PDU_QUOTATION_ChgSubscribeInstrumentsL1Add_H
#define FEEDOS_generated_PDU_QUOTATION_ChgSubscribeInstrumentsL1Add_H

#include "gen_pdu_QUOTATION_notifications.h"

namespace FeedOS
{
namespace PDU_outbound_QUOTATION_ChgSubscribeInstrumentsL1Add
{
	class Request: public PDU_outbound_Request
	{
	public:
		inline Request (uint32 const & a, ListOfPolymorphicInstrumentCode const & b, bool c) :
			PDU_outbound_Request (IDS::Request_QUOTATION_ChgSubscribeInstrumentsL1Add)
		{
	...
	public:
		inline Response (ReturnCode rc) :
			PDU_outbound_Response (IDS::Response_QUOTATION_ChgSubscribeInstrumentsL1Add, rc)
		{}
		inline Response (ListOfInstrumentStatusL1 const & a) :
			PDU_outbound_Response (IDS::Response_QUOTATION_ChgSubscribeInstrumentsL1Add, RC_OK)
		{
...
namespace PDU_inbound_QUOTATION_ChgSubscribeInstrumentsL1Add
{
	class Request: public PDU_inbound_Request
	{
	public:
		inline Request (PDU const & p) :
			PDU_inbound_Request (IDS::Request_QUOTATION_ChgSubscribeInstrumentsL1Add, p)
		{
	...
	public:
		inline Response (PDU const & p) :
			PDU_inbound_Response (IDS::Response_QUOTATION_ChgSubscribeInstrumentsL1Add, p)
		{
