...
src/%.o: ../src/%.cpp
	...
	g++ -DTARGET_PLATFORM_LINUX -I"/home/abhishek/Documents/TradingApplication/Price_Publisher/FEED_OS/ubuntu/feedos/samples/zmq_price_publish_execv1/api/include" -O3 -Wall -c -fmessage-length=0 -MMD -MP -MF"$(@:%.o=%.d)" -MT"$(@)" -o "$@" "$<"
